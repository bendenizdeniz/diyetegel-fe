    ...
    return (
        <div>
            ...
            <div className='container formStyle' style={{ marginTop: '2rem' }}>
                <h2 style={{ marginBottom: '2rem', marginTop: '2rem', textAlign: 'center', color: 'black' }}>Yemek Sepetimiz</h2>
                {cartLength != 0 ?
                                    ...
                                    <div class="card" style={{ borderRadius: '3rem' }}>
                                        <div class="card-body" >
                                            <div style={{ textAlign: 'center' }}>
                                                ...
                                                <br />
                                                <button class="btn btn-dark btn-sm" onClick={(e) => { addToCart(item) }}>Sepete Ekle</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
